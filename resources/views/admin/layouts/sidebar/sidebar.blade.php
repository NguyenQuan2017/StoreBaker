            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> TYPE PRODUCTS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      
                      <li><a href="{{route('type-product')}}">DANH SÁCH</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i>CUSTOMER <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">DANH SÁCH</a></li>
                    </ul>
                  </li>

                    <li><a><i class="fa fa-table"></i>SLIDER <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">DANH SÁCH</a></li>
                    </ul>
                  </li>
